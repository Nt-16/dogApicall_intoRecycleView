...
**Doggo** is an android app that **displays a scrollable list of dogs from the Dog API")**
...
- [x] Define and apply at least one style in **themes.xml** `themes.xml` or a new file `styles.xml`
